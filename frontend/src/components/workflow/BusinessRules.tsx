          ...
          <div className="space-y-3">
            {rules.length === 0 ? (
              ...
              rules.map((r) => (
                <div
                  key={r.id}
                  className="rounded-sm border border-slate-200 bg-white p-4 shadow-xs hover:shadow-md transition"
                >
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <div className="rounded-sm border border-slate-200 bg-white p-5 shadow-xs space-y-4">
            ...
            <CustomButton
              ...
              disabled={simulating}
              className="w-full bg-primary-600 hover:opacity-90 text-white font-bold"
            >
