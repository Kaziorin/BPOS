...
> = {
  ...
  teal: {
    light: "bg-white border-slate-200/90 text-slate-800 focus:border-[#00897b] focus:ring-2 focus:ring-[#00897b]/20",
    dark: "bg-slate-800 border-slate-700 text-slate-100 focus:border-teal-400 focus:ring-2 focus:ring-teal-400/20",
