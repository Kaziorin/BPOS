...
function WorkflowContent() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="relative overflow-hidden rounded-sm border border-slate-200 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 p-6 text-white shadow-md">
