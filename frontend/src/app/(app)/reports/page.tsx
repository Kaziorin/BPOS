...
function ReportsContent() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {toast && (
        <div
          className={`flex items-center justify-between rounded-sm border p-4 text-sm font-medium shadow-2xs transition-all animate-in fade-in-50 duration-200 ${
            toast.type === "success"
        ...
        <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <CustomButton
              ...
              className="bg-white/15 text-white border-white/30 hover:bg-white/25 rounded-sm"
            >
              <Save size={14} />
              <span>Save View</span>
            </CustomButton>
      ...
      {loading ? (
        <div className="py-20 text-center">
          <RefreshCw size={28} className="mx-auto animate-spin text-sky-500" />
          ...
          {activeTab === "installments" && installmentSummary && (
            <>
              ...
              {overdueInstallments.length > 0 && (
                <div className="rounded-sm border border-rose-200 bg-white p-5 shadow-2xs space-y-4">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="rounded-sm p-1.5 border border-rose-200 bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white transition shadow-2xs"
                        >
                          <Trash2 size={14} />
                        </button>
                      </div>
