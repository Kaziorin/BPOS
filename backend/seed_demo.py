...
MODULES = [
    ...
    ("pos", "POS & Checkout Engine", "CORE", "Monitor", "/retail-pos", 14),
    ...
    ("retail", "Retail", "INDUSTRY", "ShoppingBag", "/retail", 52),
    ("grocery", "Grocery / Supermarket", "INDUSTRY", "Scale", "/grocery", 53),
    ("wholesale", "Wholesale & Distribution", "INDUSTRY", "Truck", "/wholesale", 54),
...
MODULE_SUB_PAGES = {
    ...
    "pos": [
        ("Held Sales", "/retail-pos/holds"),
        ("Self Checkout", "/retail-pos/self-checkout"),
        ("Price Checker", "/retail-pos/price-checker"),
    ],
    ...
    "restaurant": [
        ...
        ("Kitchen Management", "/restaurant?tab=kds"),
