...
def main():
    print("Python FastAPI smoke test (Production Architecture)")
    # 1. health
    ...
    check("dashboard", s == 200 and ("totalSales" in b.get("data", {}) or "todaySalesTotal" in b.get("data", {})))
    s, b = req("GET", "/api/v1/dashboard/trend")
    check("dashboard trend", s == 200 and isinstance(b.get("data"), list))
